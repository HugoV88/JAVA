...
public class EjemploHerencia {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Imprimimos el empleado 1:");
        ...
        System.out.println("\nImprimimos el cliente 1:");
        System.out.println(c1);
        //Completamos el objeto asociado a este objeto cliente
        c1.setNombre("Karla");
        c1.setEdad(22);
        c1.setGenero('F');
        c1.setDireccion("Mexico, DF");
        System.out.println("\nVolvamos a imprimir el cliente 1:");
        System.out.println(c1);
